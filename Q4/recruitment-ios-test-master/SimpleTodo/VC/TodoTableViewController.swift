...
//        let sortDescriptors = NSSortDescriptor(key: "data", ascending: true)
        ...
        let sortDescriptors = NSSortDescriptor(key: "date", ascending: true) //fixes
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath)  typo identifier
