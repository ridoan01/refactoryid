...
//        let sortDescriptorsNotes = NSSortDescriptor(key: "data", ascending: true)
        ...
        let sortDescriptorsNotes = NSSortDescriptor(key: "date", ascending: true) //fixes 2
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) noteCell
